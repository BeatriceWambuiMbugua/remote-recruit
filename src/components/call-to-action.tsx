...
const CallToAction = () => {
  return (
    <div className="relative bg-[url('/assets/background-image.svg')] bg-cover bg-center min-h-screen px-4 flex flex-col justify-center items-center text-center overflow-hidden max-md:flex-col max-md:px-6 max-md:py-2 max-md:gap-12" data-aos="slide-up" data-aos-duration="2000">
